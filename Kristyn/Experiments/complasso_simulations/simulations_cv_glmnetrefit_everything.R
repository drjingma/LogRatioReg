...
# Date: 06/30/2021
# Notes: glmnetrefit for not just beta (like in aim31) but also prediction

getwd()
output_dir = "Kristyn/Experiments/complasso_simulations/output_glmnetrefitall"
...
evals = foreach(
  ...
  slr.a0 = refit_exact$a0 # slr$int[slr.lam.min.idx]
  slr.thetahat = as.matrix(refit_exact$beta) # slr$bet[, slr.lam.min.idx]
