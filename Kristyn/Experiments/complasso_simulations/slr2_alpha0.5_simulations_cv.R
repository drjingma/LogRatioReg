...
if(beta.settings == "old" | beta.settings == "linetal2014"){
  saveRDS(evals, file = paste0(output_dir, "/slr2_alpha0.5_cv_sims_old", file.end))
  saveRDS(evals.df, file = paste0(output_dir, "/slr2_alpha0.5_cv_summaries_old", file.end))
} else{
  saveRDS(evals, file = paste0(output_dir, "/slr2_alpha0.5_cv_sims", file.end))
  saveRDS(evals.df, file = paste0(output_dir, "/slr2_alpha0.5_cv_summaries", file.end))
}
