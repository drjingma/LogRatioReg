...
# quick question -- what happens when we center the log-ratios and y?
slrDistMat2 = getSupervisedMatrixCentering(
  y = Y, X = X, type = "distance")
# fields::image.plot(slrDistMat)
# fields::image.plot(slrDistMat2)
all.equal(slrDistMat, slrDistMat2) # TRUE
