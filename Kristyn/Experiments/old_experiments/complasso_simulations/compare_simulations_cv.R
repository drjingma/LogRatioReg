...
## my newest results using my slr functions and fitting slr and classo
##    generated in simulations_cv_kristyn.R
# output_dir = "Kristyn/Experiments/complasso_simulations/output_kristyn"

## results modeled after aim31, 
##    which uses cv.glmnet for predictions, but beta from refitted glmnet
##    generated in simulations_cv_aim31.R
# output_dir = "Kristyn/Experiments/complasso_simulations/output_aim31"

## results that use cvglmnet for everything, hopefully the same as my newest
##    results using my functions (or, comparable, since train/test data is 
##    generated altogether like in aim31, instead of separately, like in 
##    simulations_cv_kristyn.R)
##    generated in simulations_cv_cvglmnet.R
# output_dir = "Kristyn/Experiments/complasso_simulations/output_cvglmnet"

## results that use the glmnet refit (with optimal lambda from cv.glmnet) for
##    everything
##    generated by simulations_cv_glmnetrefit.R
