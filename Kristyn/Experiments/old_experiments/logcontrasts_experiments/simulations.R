# Purpose: Simulate data from linear log contrasts model to compare
...
output_dir = "Kristyn/Experiments/logcontrasts_experiments/outputs"
...
res = foreach(
  ...
  ##############################################################################
  # note: oracle isn't for this setting
  ##############################################################################
