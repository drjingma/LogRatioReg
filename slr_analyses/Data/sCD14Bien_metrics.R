...
res = foreach(
  ...
  # if(
  #   !file.exists(paste0(output_dir, "/data", file.end)) & 
  #   # !is.null(file.exists(paste0(output_dir, "/classo_metrics", file.end))) & 
  #   # !is.null(file.exists(paste0(output_dir, "/slr_spectral_sbp", file.end))) & 
  #   # !is.null(file.exists(paste0(output_dir, "/slr_hierarchical_sbp", file.end))) & 
  #   # !is.null(file.exists(paste0(output_dir, "/codacore_sbp", file.end))) & 
  #   !file.exists(paste0(output_dir, "/lrlasso_metrics", file.end))
  # ){
  #  print("doesn't exist") 
  # }
    ################################################################################
