...
b0 = 0 # 0
b1 = 10 # 0.5
c = 10 # like theta but in terms of manuscript definitions
# theta.value = 10 # weight on a1 -- 0.4, 0.5
a0 = 0 # 0
n.unlabeled = n * 100
ulimit = 0.5
...
ggplot() + 
  geom_function(fun = funBeta1CorXjY, xlim = c(0, 20), aes(color = "Cor(clr(Xj), y)")) + 
